...
Bad: "The recipe table records the stripped indexes — but does not preserve `M` or `ef_construction`."

Better: "The recipe table records the stripped indexes. It does not preserve `M` or `ef_construction`."
...
- **Checklist features:** Emoji bullet lists (checkmark + feature name). Reads like a product launch, not technical documentation.
